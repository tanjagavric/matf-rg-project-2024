    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Configures the model for GPU instanced rendering.
        *
        * @param model_matrices Transformation matrices for each instance. Vector size determines instance count.
        * @note Must be called before draw_instanced().
        * @see draw_instanced()
        */
        void setup_instancing(const std::vector<glm::mat4> &model_matrices);

        /**
        * @brief Draws multiple instances of the model using instanced rendering.
        * @param shader The shader to use for drawing.
        * @note Requires setup_instancing() to be called first to configure instance data.
        * @see setup_instancing()
        */
        void draw_instanced(Shader *shader) const;
    ...
    private:
        ...
        */
        ...
        unsigned int m_instance_amount = 0;
